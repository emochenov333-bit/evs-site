...
export function ServiceIcon({ name, className = '' }: { name: string; className?: string }) {
  const icons: Record<string, ReactNode> = {
    ...
    network: <NetworkIcon className={className} />,
    automation: <AutomationIcon className={className} />,
    wind: <WindIcon className={className} />,
    key: <KeyIcon className={className} />,
    team: <TeamIcon className={className} />,
    document: <DocumentIcon className={className} />,
    payment: <PaymentIcon className={className} />,
    blueprint: <BlueprintIcon className={className} />,
    site: <SiteIcon className={className} />,
    construction: <ConstructionIcon className={className} />,
    engineering: <EngineeringIcon className={className} />,
    settings: <SettingsIcon className={className} />,
    handover: <HandoverIcon className={className} />,
    ribbon: <RibbonIcon className={className} />,
  }

  return <>{icons[name] ?? <BuildingIcon className={className} />}</>
}
...
function FireIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M12 22c4-2 6-6 6-10 0-4-3-6-6-8-3 2-6 4-6 8 0 4 2 8 6 10z" strokeLinecap="round" strokeLinejoin="round" />
...
function NetworkIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M12 7v4M8 15l4-4 4 4" strokeLinecap="round" />
    </svg>
  )
}
...
function WindIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M9.5 6A4.5 4.5 0 1 1 5 10.5M14 6h7M5 14h14M7 18h10" strokeLinecap="round" />
    </svg>
  )
}
...
function KeyIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M12 15h9M17 12v6" strokeLinecap="round" />
    </svg>
  )
}
...
function TeamIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M2 21v-1a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v1M15 16a4 4 0 0 1 4 4v1" strokeLinecap="round" />
    </svg>
  )
}
...
function BlueprintIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M14 2H6a2 2 0 0 0-2 2v16l6-3 6 3 6-3V8l-6-3z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
function ConstructionIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M2 20h20M6 20V10l6-4 6 4v10" strokeLinecap="round" strokeLinejoin="round" />
...
function HandoverIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
function RibbonIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M12 15l-4 9 4-5 4 5-4-9M8 3h8l-1 8H9L8 3z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
